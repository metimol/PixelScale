import svgPaths from "./svg-3bujfkkrs7";
...
function Frame6() {
  return (
    <div className="bg-[#f1d302] box-border content-stretch flex flex-row gap-2.5 items-center justify-center overflow-clip px-[5px] py-2 relative rounded-lg shrink-0">
      <div className="flex flex-col font-['Pixelify_Sans:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#000000] text-[30px] text-center text-nowrap">
...
function Frame7() {
  return (
    <div className="relative rounded-lg shrink-0 w-[146px]">
      <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center overflow-clip px-[5px] py-2 relative w-[146px]">
...
function Upload() {
  return (
    <div className="absolute left-[82px] top-[350px]" data-name="Upload">
      <div className="box-border content-stretch flex flex-col gap-5 items-center justify-center overflow-clip px-[391px] py-[60px] relative">
        <div className="flex flex-col font-['Pixelify_Sans:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f1d302] text-[30px] text-center text-nowrap">
...
export default function MainPageUploaded() {
  return (
    <div
      className="bg-[#020100] relative size-full"
      data-name="Main page (uploaded)"
    >
      <Footer />
      <Body />
      <Header />
