import svgPaths from "./svg-2ij2klx2ty";
...
function Frame6() {
  return (
    <div className="bg-[#f1d302] box-border content-stretch flex flex-row gap-2.5 items-center justify-center overflow-clip px-[5px] py-2 relative rounded-lg shrink-0">
      <div className="flex flex-col font-['Pixelify_Sans:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#000000] text-[20px] text-center text-nowrap">
...
function Frame7() {
  return (
    <div className="relative rounded-lg shrink-0 w-[101px]">
      <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center overflow-clip px-[5px] py-2 relative w-[101px]">
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2.5 items-center justify-center px-[391px] py-[50px] relative w-[334px]">
          <div className="flex flex-col font-['Pixelify_Sans:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f1d302] text-[25px] text-center text-nowrap">
...
export default function MainPageUploadedPhone() {
  return (
    <div
      className="bg-[#020100] relative size-full"
      data-name="Main page (uploaded) (phone)"
    >
      <Footer />
      <Body />
      <Header />
