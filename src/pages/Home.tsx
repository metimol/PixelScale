...
import { processImageForUpscaling, dataUrlToBlob, ProcessedImage } from "../utils/imageProcessor";
...
export default function Home() {
  ...
  return (
    <div className="bg-[#020100] min-h-screen relative text-[#f1d302] flex flex-col" data-name="Main page">
      <Header isMobile={isMobile} />

      {/* Body */}
      <main className="flex-1 relative px-4 md:px-[50px] py-8 md:py-16 overflow-hidden">
        {/* Free Tool Badge */}
